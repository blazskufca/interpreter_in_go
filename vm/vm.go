...
func (vm *VM) Run() error {
	...
	var frameInstructions code.Instructions
	var OPCODE code.Opcode
	for vm.currentFrame().ip < len(vm.currentFrame().Instructions())-1 {
		vm.currentFrame().ip++
		instructionPointer = vm.currentFrame().ip
		frameInstructions = vm.currentFrame().Instructions()
		OPCODE = code.Opcode(frameInstructions[instructionPointer])
		...
		case code.OpConstant:
			...
			constIndex := code.ReadUint16(frameInstructions[instructionPointer+1:])
		...
		case code.OpJump:
			pos := int(code.ReadUint16(frameInstructions[instructionPointer+1:]))
		...
		case code.OpSetGlobal:
			globalIndex := code.ReadUint16(frameInstructions[instructionPointer+1:])
		...
		case code.OpArray: // Doing what's described in code/code.go
			numElements := int(code.ReadUint16(frameInstructions[instructionPointer+1:])) // Decode the instruction
		...
		case code.OpHash:
			numElements := int(code.ReadUint16(frameInstructions[instructionPointer+1:]))
			vm.currentFrame().ip += 2
